...
namespace EMS
{
    public static class DataSource
    {
        ...
        static public void PopulateData()
        {
            ...
            {
                new LeaveApplication() { propLeaveApplicationId=12,propEmployeeId3=1,propLeaveTypeId=1,propStartDate=new DateTime(2017,11,01),propEndDate=new DateTime(2017,11,11),propAppliedDate=new DateTime(2017,10,20),propLeaveDay=Leavetype.Fullday,propLeaveReason="Casual Leave",propManagerId2=new List<int> {100,99,88,77 },propAlternateContactId="+91 9876987698",propleavestatus=LeaveStatus.Approve,propNoOfDays3=10 },
                new LeaveApplication() { propLeaveApplicationId=13,propEmployeeId3=2,propLeaveTypeId=2,propStartDate=new DateTime(2017,11,01),propEndDate=new DateTime(2017,11,21),propAppliedDate=new DateTime(2017,10,30),propLeaveDay=Leavetype.HalfDayFirstHalf,propLeaveReason="Sick Leave",propManagerId2=new List<int> {101,98,87,76 },propAlternateContactId="+91 9879879879",propleavestatus=LeaveStatus.Approve,propNoOfDays3=20 }
            };
            ...
            ul = new List<User>
            {
                new User() {propId=1,propLoginName="tonystark",propPassword="ironman",propIsActive2=true,propSecurityQuestion="Who am I?",propSecurityAnswer="Playboy" },
                new User() {propId=2,propLoginName="brucewayne",propPassword="batman",propIsActive2=true,propSecurityQuestion="What am I?",propSecurityAnswer="Billionaire" }
            };
        }
    }
}