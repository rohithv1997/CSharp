...
namespace EmployeeLeaveManagement
{
    ...
    public class MailGenerator
    {
        ...
        public MailGenerator(string f, string l)
        {
    ...
    {
        readonly public string eid2;
        public EIDGenerator()
        {

            Random r = new Random();
            int v = r.Next(1000);
            eid2 = 'E' + v.ToString("000");
            Console.WriteLine("Generated EmployeeID in EID Generator= {0}", eid2);
            //return eid;
        }
        public string giveeid()
        {
            return eid2;
        }
    }
    ...
    public class Employee
    {
        ...
        enum LeaveStatus
        {
            Approve, Rejected, Cancelled, Pending
        }

        enum LeaveType
        {
            Fullday, HalfDayFirstHalf, HalfDaySecondHalf
        }
        ...
        public void AcceptEmployeeDetails()
        {
            ...
            //Console.Clear();
            Console.WriteLine("Generated EmployeeID: {0}", EmployeeID);
        }
        ...
        void genEID()
        {
            EIDGenerator e2 = new EIDGenerator();
            EmployeeID = e2.giveeid();

        }
        public void genEmailID()
        {
            MailGenerator m2 = new MailGenerator(propFirstName, propLastName);
            mailid = m2.givemail();
            genPassword();
        }
        public string accessEmployeeID()
        {
            return EmployeeID;
        }
